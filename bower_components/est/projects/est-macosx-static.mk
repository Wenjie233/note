#
#   est-macosx-static.mk -- Makefile to build Embethis EST for macosx
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/est-macosx-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/est-macosx-static-me.h >/dev/null ; then\
		cp projects/est-macosx-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true

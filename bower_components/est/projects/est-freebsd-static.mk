#
#   est-freebsd-static.mk -- Makefile to build Embethis EST for freebsd
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/est-freebsd-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/est-freebsd-static-me.h >/dev/null ; then\
		cp projects/est-freebsd-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true

#
#   est-vxworks-default.mk -- Makefile to build Embethis EST for vxworks
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/est-vxworks-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/est-vxworks-default-me.h >/dev/null ; then\
		cp projects/est-vxworks-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
$(BUILD)/obj/aes.o: \
	...
	$(CC) -c -o $(BUILD)/obj/aes.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/aes.c
...
$(BUILD)/obj/arc4.o: \
	...
	$(CC) -c -o $(BUILD)/obj/arc4.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/arc4.c
...
$(BUILD)/obj/base64.o: \
	...
	$(CC) -c -o $(BUILD)/obj/base64.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/base64.c
...
$(BUILD)/obj/bignum.o: \
	...
	$(CC) -c -o $(BUILD)/obj/bignum.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/bignum.c
...
$(BUILD)/obj/camellia.o: \
	...
	$(CC) -c -o $(BUILD)/obj/camellia.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/camellia.c
...
$(BUILD)/obj/certs.o: \
	...
	$(CC) -c -o $(BUILD)/obj/certs.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/certs.c
...
$(BUILD)/obj/debug.o: \
	...
	$(CC) -c -o $(BUILD)/obj/debug.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/debug.c
...
$(BUILD)/obj/des.o: \
	...
	$(CC) -c -o $(BUILD)/obj/des.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/des.c
...
$(BUILD)/obj/dhm.o: \
	...
	$(CC) -c -o $(BUILD)/obj/dhm.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/dhm.c
...
$(BUILD)/obj/havege.o: \
	...
	$(CC) -c -o $(BUILD)/obj/havege.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/havege.c
...
$(BUILD)/obj/md2.o: \
	...
	$(CC) -c -o $(BUILD)/obj/md2.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/md2.c
...
$(BUILD)/obj/md4.o: \
	...
	$(CC) -c -o $(BUILD)/obj/md4.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/md4.c
...
$(BUILD)/obj/md5.o: \
	...
	$(CC) -c -o $(BUILD)/obj/md5.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/md5.c
...
$(BUILD)/obj/net.o: \
	...
	$(CC) -c -o $(BUILD)/obj/net.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/net.c
...
$(BUILD)/obj/padlock.o: \
	...
	$(CC) -c -o $(BUILD)/obj/padlock.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/padlock.c
...
$(BUILD)/obj/rsa.o: \
	...
	$(CC) -c -o $(BUILD)/obj/rsa.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/rsa.c
...
$(BUILD)/obj/sha1.o: \
	...
	$(CC) -c -o $(BUILD)/obj/sha1.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/sha1.c
...
$(BUILD)/obj/sha2.o: \
	...
	$(CC) -c -o $(BUILD)/obj/sha2.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/sha2.c
...
$(BUILD)/obj/sha4.o: \
	...
	$(CC) -c -o $(BUILD)/obj/sha4.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/sha4.c
...
$(BUILD)/obj/ssl_cli.o: \
	...
	$(CC) -c -o $(BUILD)/obj/ssl_cli.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/ssl_cli.c
...
$(BUILD)/obj/ssl_srv.o: \
	...
	$(CC) -c -o $(BUILD)/obj/ssl_srv.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/ssl_srv.c
...
$(BUILD)/obj/ssl_tls.o: \
	...
	$(CC) -c -o $(BUILD)/obj/ssl_tls.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/ssl_tls.c
...
$(BUILD)/obj/timing.o: \
	...
	$(CC) -c -o $(BUILD)/obj/timing.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/timing.c
...
$(BUILD)/obj/x509parse.o: \
	...
	$(CC) -c -o $(BUILD)/obj/x509parse.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/x509parse.c
...
$(BUILD)/obj/xtea.o: \
	...
	$(CC) -c -o $(BUILD)/obj/xtea.o $(CFLAGS) $(DFLAGS) "-I$(BUILD)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/xtea.c
...
$(BUILD)/bin/libest.out: $(DEPS_54)
	@echo '      [Link] $(BUILD)/bin/libest.out'
	$(CC) -r -o $(BUILD)/bin/libest.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/aes.o" "$(BUILD)/obj/arc4.o" "$(BUILD)/obj/base64.o" "$(BUILD)/obj/bignum.o" "$(BUILD)/obj/camellia.o" "$(BUILD)/obj/certs.o" "$(BUILD)/obj/debug.o" "$(BUILD)/obj/des.o" "$(BUILD)/obj/dhm.o" "$(BUILD)/obj/havege.o" "$(BUILD)/obj/md2.o" "$(BUILD)/obj/md4.o" "$(BUILD)/obj/md5.o" "$(BUILD)/obj/net.o" "$(BUILD)/obj/padlock.o" "$(BUILD)/obj/rsa.o" "$(BUILD)/obj/sha1.o" "$(BUILD)/obj/sha2.o" "$(BUILD)/obj/sha4.o" "$(BUILD)/obj/ssl_cli.o" "$(BUILD)/obj/ssl_srv.o" "$(BUILD)/obj/ssl_tls.o" "$(BUILD)/obj/timing.o" "$(BUILD)/obj/x509parse.o" "$(BUILD)/obj/xtea.o" $(LIBS) 
endif

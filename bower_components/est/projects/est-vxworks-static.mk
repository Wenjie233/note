#
#   est-vxworks-static.mk -- Makefile to build Embethis EST for vxworks
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/est-vxworks-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/est-vxworks-static-me.h >/dev/null ; then\
		cp projects/est-vxworks-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true

#
#   est-macosx-default.mk -- Makefile to build Embethis EST for macosx
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/est-macosx-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/est-macosx-default-me.h >/dev/null ; then\
		cp projects/est-macosx-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
$(BUILD)/obj/aes.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/aes.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/aes.c
...
$(BUILD)/obj/arc4.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/arc4.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/arc4.c
...
$(BUILD)/obj/base64.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/base64.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/base64.c
...
$(BUILD)/obj/bignum.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/bignum.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/bignum.c
...
$(BUILD)/obj/camellia.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/camellia.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/camellia.c
...
$(BUILD)/obj/certs.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/certs.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/certs.c
...
$(BUILD)/obj/debug.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/debug.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/debug.c
...
$(BUILD)/obj/des.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/des.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/des.c
...
$(BUILD)/obj/dhm.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/dhm.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/dhm.c
...
$(BUILD)/obj/havege.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/havege.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/havege.c
...
$(BUILD)/obj/md2.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/md2.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/md2.c
...
$(BUILD)/obj/md4.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/md4.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/md4.c
...
$(BUILD)/obj/md5.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/md5.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/md5.c
...
$(BUILD)/obj/net.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/net.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/net.c
...
$(BUILD)/obj/padlock.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/padlock.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/padlock.c
...
$(BUILD)/obj/rsa.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/rsa.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/rsa.c
...
$(BUILD)/obj/sha1.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/sha1.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/sha1.c
...
$(BUILD)/obj/sha2.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/sha2.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/sha2.c
...
$(BUILD)/obj/sha4.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/sha4.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/sha4.c
...
$(BUILD)/obj/ssl_cli.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/ssl_cli.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/ssl_cli.c
...
$(BUILD)/obj/ssl_srv.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/ssl_srv.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/ssl_srv.c
...
$(BUILD)/obj/ssl_tls.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/ssl_tls.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/ssl_tls.c
...
$(BUILD)/obj/timing.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/timing.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/timing.c
...
$(BUILD)/obj/x509parse.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/x509parse.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/x509parse.c
...
$(BUILD)/obj/xtea.o: \
	...
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/xtea.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/xtea.c
...
$(BUILD)/bin/libest.dylib: $(DEPS_54)
	@echo '      [Link] $(BUILD)/bin/libest.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libest.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libest.dylib -compatibility_version 0.6 -current_version 0.6 "$(BUILD)/obj/aes.o" "$(BUILD)/obj/arc4.o" "$(BUILD)/obj/base64.o" "$(BUILD)/obj/bignum.o" "$(BUILD)/obj/camellia.o" "$(BUILD)/obj/certs.o" "$(BUILD)/obj/debug.o" "$(BUILD)/obj/des.o" "$(BUILD)/obj/dhm.o" "$(BUILD)/obj/havege.o" "$(BUILD)/obj/md2.o" "$(BUILD)/obj/md4.o" "$(BUILD)/obj/md5.o" "$(BUILD)/obj/net.o" "$(BUILD)/obj/padlock.o" "$(BUILD)/obj/rsa.o" "$(BUILD)/obj/sha1.o" "$(BUILD)/obj/sha2.o" "$(BUILD)/obj/sha4.o" "$(BUILD)/obj/ssl_cli.o" "$(BUILD)/obj/ssl_srv.o" "$(BUILD)/obj/ssl_tls.o" "$(BUILD)/obj/timing.o" "$(BUILD)/obj/x509parse.o" "$(BUILD)/obj/xtea.o" $(LIBS) 
endif

#
#   est-linux-default.mk -- Makefile to build Embethis EST for linux
#
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/est-linux-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/est-linux-default-me.h >/dev/null ; then\
		cp projects/est-linux-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
